...
const LocaleEn = {
  "values": {
    ...
    "setting.hotkey-switch-enabled-input.label": "Enable hotkey <kbd>alt</kbd> + <kbd>shift</kbd> + <kbd>c</kbd> (clip switch)",
    ...
    "setting.restore-from-file-intro.label": "Restore config data from JSON file",
    ...
    "history.th.handler": "Handler",
    "history.th.clip-id": "ID",
    ...
    "reset.current-storage-path-value": "<code>download path</code> / <code>$ROOT-FOLDER</code>, <code>$ROOT-FOLDER</code> is the name of root folder, if this name is different to the folder you'll choose, please go to <a href='go.page:extPage.setting#setting-storage' target='_blank'>Setting &gt; Storage</a> page and change the value of root folder first.",
